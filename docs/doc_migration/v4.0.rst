...
5 - Si vous commencez par cette version 4 ou bien souhaitez repartir de zéro, vous pouvez récupérer directement les sous-dépôts avec l'option ``--recurse-submodules`` ::
